...
const NavBar = () => {
  ...
  return (
    <nav
      className={`bg-[#147073] shadow-sm fixed top-0 w-full z-50 ${
        theme ? "dark" : ""
      } dark:bg-zinc-600`}
    >
      <div
        className={`navbar bg-[#147073] dark:bg-zinc-600  max-w-7xl mx-auto`}
      >
        <div className="navbar-start">
          ...
          <div className="flex gap-0 sm:gap-2 items-center">
            ...
            <a className="text-xs sm:text-xl font-extrabold text-[#d9cab3] ">

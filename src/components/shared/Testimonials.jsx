 ...
 */}
          <div className="relative mt-10 md:mt-24 md:order-2 ">
            ...
            <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
              <div className="flex flex-col overflow-hidden shadow-xl rounded-lg ">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white  dark:bg-zinc-400 text-gray-600  lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed dark:text-white text-gray-900 font-pj">
                        ...
                        Highly recommended for stress-free travel!”
                      </p>
                    </blockquote>
                  </div>
                  ...
                  <div className="flex items-center mt-8">
                    ...
                    />
                    <div className="ml-4">
                      <p className="text-base font-bold dark:text-white text-gray-900 font-pj">
                        Tanvir Ahmed
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex flex-col overflow-hidden shadow-xl rounded-lg">
                <div className="flex flex-col justify-between flex-1 p-6  dark:bg-zinc-400 text-gray-600 bg-white lg:py-8 lg:px-7">
                  <div className="flex-1">
                    <div className="flex items-center">
                      <svg
                        className="w-5 h-5 text-[#FDB241]"
